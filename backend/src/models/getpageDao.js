...
//     startDate.replace(/%20/g, " ")
//   ).toISOString();
//   const parsedEndDate = new Date(endDate.replace(/%20/g, " ")).toISOString();

//   // const andStartDate = `AND ${startDate} <= c.start_date`;
//   // const andEndDate = `AND ${endDate} <= c.end_date`;
